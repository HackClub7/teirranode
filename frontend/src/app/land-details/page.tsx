...
export default function LandDetails() {
    ...
    return (
        <div className="text-black">
            <Header />
            <div className="py-10 border-b lg:px-32">
                <div className="grid grid-cols-2 gap-14">
                    ...
                    <div className="text-black text-sm">
                        ...
                        <p className="pt-3 leading-6 text-slate-500">Lorem ipsum dolor sit amet consectetur. Blandit adipiscing lectus odio netus sed nam lobortis amet. Id ut lorem magna iaculis suspendisse eget. Pharetra sed egestas auctor eget. Aliquam sodales quis enim amet blandit in natoque sed elementum.</p>
                        ...
                        <p className="pt-5">Land ID: <span className="font-semibold text-[#22331D]"> Pl 234009</span></p>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white w-1/3 rounded shadow-lg p-6 relative">
                        ...
                        <div className="flex justify-end gap-2">
                            <button
                                onClick={closeModal}
                               className="hover:bg-[#F65A11] bg-[#22331D] text-white text-sm py-2 px-3 rounded"
                            >
                                Yes
                            </button>
                            <button
                                onClick={closeModal}
                                className="border border-[#22331D] text-sm py-2 px-3 rounded text-[#22331D] hover:text-white hover:bg-[#F65A11] hover:border-transparent"
                            >
                                Cancel
                            </button>
                        </div>
